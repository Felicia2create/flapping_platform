...
def generate_launch_description():
    ...
    your_package_share = get_package_share_directory('flapping_platform_description')

    new_urdf_path = os.path.join(your_package_share, 'urdf', 'robots', 'flapping_platform_real.urdf.xacro')

    moveit_config = (
        MoveItConfigsBuilder("rml_63_description", package_name="rm_63_config")
        .robot_description(file_path=new_urdf_path , mappings={"link6_type": "Link6_6fb","base_type": "base_link_III"})
