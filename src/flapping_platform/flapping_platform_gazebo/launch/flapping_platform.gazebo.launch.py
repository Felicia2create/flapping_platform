...
def generate_launch_description():
    ...
    package_name_gazebo = 'flapping_platform_gazebo'
    package_name_description = 'flapping_platform_description'
    package_name_moveit = 'flapping_platform_moveit_config'
    # gazebo中的模型名称
    default_robot_name = 'flapping_platform'
